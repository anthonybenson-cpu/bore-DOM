...
document.querySelector('heading').style.fontSize = '42px'
// 3. Replace the text in the paragraph with the new Lorem Ipsum content.
document.querySelector('p').innerText = 'nothing to see here.'
// 4. Reduce the opacity of the 13th item to 30% transparency.
document.querySelector('#item-13').style.opacity = '0.3'
...
console.log('This Might Be A DOM Idea')